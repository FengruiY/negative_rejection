% Use formulas for spiral wound membranes to calculate the mass transfer coefficient (K_c,i)
% Evangelista, F. An improved analytical method for the design of spiral-wound modules. The Chemical Engineering Journal 38, 33–40 (1988).

function y = solve_kc(N_leaf,W_module,Q0,WR,temp)
Difu_298 = [1.03E-09 7.07E-10 2.03E-09]';
vis_u = exp(-10.5+530/(temp-146)); % Pa·s
